    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: 'Roboto', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
          ...
          <p style="margin-top: 20px; font-size: 16px; line-height: 1.5;">${post.description}</p>
          <p style="margin-top: 20px; font-style: italic; color: #555; font-size: 14px; line-height: 1.5;">Written by: <strong>${post.author}</strong></p>
          <a href="https://gospel-mission.vercel.app/post/${post.slug}" 
             style="display: inline-block; margin-top: 20px; background-color: #2980b9; color: white; text-decoration: none; padding: 12px 20px; border-radius: 5px; text-align: center; font-weight: bold; font-family: 'Roboto', Arial, sans-serif; font-size: 18px;">
            Read More
          </a>
